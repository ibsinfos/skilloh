...
if($_REQUEST['delete']=="1")
{
	...
	{
		$deleteme = $DPID;
		$query = "DELETE FROM bans_words WHERE word='".mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $deleteme)."'";
		$conn->Execute($query);
...
if($word!="")
{
	$addtosql .= "WHERE word like'%".mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $word)."%'";
