                        ...
                        <div class="cusongsblock {if $smarty.section.i.iteration % 3 == 0}last{/if}">
                            ...
                            <div class="price">{if $scriptolution_cur_pos eq "1"}{$posts[i].price|stripslashes}{$lang197}{else}{$lang197}{$posts[i].price|stripslashes}{/if}</div>
                            <p>
