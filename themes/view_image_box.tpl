    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <ul id="carousel">
            ...
            <li class="carouselItem">
                <div class="carouselImage"><img class="img-responsive" src="{$purl}/t3/{$p.p1}?{$smarty.now}" /></div>
            </li>
            {if $p.p2 ne ""}
            <li class="carouselItem">
                <div class="carouselImage"><img class="img-responsive" src="{$purl}/t3/{$p.p2}?{$smarty.now}" /></div>
            </li>
            {/if} 
            {if $p.p3 ne ""}
            <li class="carouselItem">
                <div class="carouselImage"><img class="img-responsive" src="{$purl}/t3/{$p.p3}?{$smarty.now}" /></div>
            </li>
            {/if}
            {if $p.p4 ne ""}
            <li class="carouselItem">
                <div class="carouselImage"><img class="img-responsive" src="{$purl}/t3/{$p.p4}?{$smarty.now}" /></div>
            </li>
            {/if}
            {if $p.p5 ne ""}
            <li class="carouselItem">
                <div class="carouselImage"><img class="img-responsive" src="{$purl}/t3/{$p.p5}?{$smarty.now}" /></div>
            </li>
            {/if}
        </ul>
    </div>
