<div class="whiteBox homescriptolutionreq">
    ...
    <div class="scriptolution-table myrequests">
        <table>
            ...
            <tbody>
                {insert name=afewscriptolutionrequests value=a assign=newscriptolutions} {if $newscriptolutions|@count eq "0"}
                <tr>
                    <td colspan="5">
                        {$lang633}
                ...
                {else} {section name=i loop=$newscriptolutions} {insert name=seo_clean_titles assign=title value=a title=$newscriptolutions[i].gtitle}
                <tr>
                    ...
                    <td class="scriptolutionmhide">
                        {if $scriptolution_cur_pos ne "1"}{$lang197}{/if}{$newscriptolutions[i].scriptolutionprice}{if $scriptolution_cur_pos eq "1"}{$lang197}{/if}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="scriptolutionmunhide">
                        {$newscriptolutions[i].scriptolutiondays} {$lang131}
                        <span style="margin-right:30px;"></span> {if $scriptolution_cur_pos ne "1"}{$lang197}{/if}{$newscriptolutions[i].scriptolutionprice}{if $scriptolution_cur_pos eq "1"}{$lang197}{/if}
                    </td>
                </tr>
                <tr>
