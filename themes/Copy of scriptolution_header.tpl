...
<head>
    ...
    <script>
     sQuery('.category-dropdown__category__link').hover(
function(){
	console.log(this);
});
    </script>
...
<nav class="header__categories category-dropdown">
   <div class="header__categories__label">
      Categories 
      <div class="header__categories__down-arrow hot-icon__arrow-down"></div>
   </div>
   <div class="category-dropdown__wrapper th-size-normal category-dropdown__categories--expanded">
      <ul class="category-dropdown__categories">
         <li class="category-dropdown__category" data-submenu-id="logo-design-branding">
            <a class="category-dropdown__category__link" href="">Logo Design &amp; Branding</a>
            <ul class="category-dropdown__subcategories" id="logo-design-branding" style="display: none;">
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="">Logo Design</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="">Logo Customization</a></li>
            </ul>
         </li>
         <li class="category-dropdown__category" data-submenu-id="wordpress">
            <a class="category-dropdown__category__link" href="/explore/content-writing">Content &amp; Copywriting</a>
            <ul class="category-dropdown__subcategories" id="content-writing">
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/website-content">Website Content</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/copywriting">Copywriting</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/press-releases">Press Releases</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/product-descriptions">Product Descriptions</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/proofreading-editing">Proofreading &amp; Editing</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/blog-article-writing">Blog &amp; Article Writing</a></li>
            </ul>
         </li>
         <li class="category-dropdown__category" data-submenu-id="video-animation">
            <a class="category-dropdown__category__link" href="/explore/video-animation">Video &amp; Animation</a>
            <ul class="category-dropdown__subcategories" id="video-animation">
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/after-effects-customization">After Effects Customization</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/video-editing">Video Editing</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/explainer-videos">Explainer Videos</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/logo-animation">Logo Animation</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/animation">Animation</a></li>
            </ul>
         </li>
         <li class="category-dropdown__category" data-submenu-id="audio">
            <a class="category-dropdown__category__link" href="/explore/audio">Audio</a>
            <ul class="category-dropdown__subcategories" id="audio">
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/audio-editing">Audio Editing</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/jingles-drops">Jingles &amp; Drops</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/mixing-mastering">Mixing &amp; Mastering</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/music-production">Music Production</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/session-musicians">Session Musicians</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/sound-design">Sound Design</a></li>
               <li class="category-dropdown__subcategory"><a class="category-dropdown__subcategory__link" href="/explore/voice-overs">Voice-overs</a></li>
            </ul>
         </li>
      </ul>
   </div>
