                    ...
                    <div id="problems_box" style="display:none;">
                        <div class="boxes">
                            <div class="box mutual-cancel first mutual_toggler">
                                <h3 class="got_prob_title"><input type="radio" class="radio_button" id="radio_mutual" name="{$lang330}" value="{$lang330}"/> <span>{$lang328}</span></h3>
                                <p>{$lang329}</p>
                            </div>
                            <div class="box force-cancel mid selected force_toggler">
                                <h3 class="got_prob_title"><input type="radio" class="radio_button" id="radio_force" name="{$lang332}" value="{$lang332}"/> <span>{$lang331}</span></h3>
                                <p>{$lang333}</p>
                            </div>
