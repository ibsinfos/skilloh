...
<div class="row showship">
    <p class="shipoption">
        <input id="shipme" name="shipme" onclick="scriptolutiontoggle('shipmore', 'shipme')" type="checkbox" value="1" /> {$langs0}
    </p>
    <div id="shipmore">
        <p class="stip">
            {$langs1}
        ...
        <div id="shipping" class="shipping-selection-form">
            <div class="shipping-settings">
                ...
                <select id="scriptolutionship1" name="scriptolutionship1" class="textfour">
                    ...
                    <option value="{$smarty.section.i.index}" {if $scriptolutionship1 eq $smarty.section.i.index}selected{/if}>{if $scriptolution_cur_pos eq "1"}{$smarty.section.i.index}{$lang197}{else}{$lang197}{$smarty.section.i.index}{/if}</option>
                    {/section}
                </select> {$langs4}
