                    ...
                    <div id="scriptolutionForm">
                        <form action="{$baseurl}invite_signup.php?c={$c}" method="post">
                            ...
                            <div class="form-entry">
                                ...
                                <div class="remember">
                                    <input class="checkbox" id="user_terms_of_use" name="user_terms_of_use" type="checkbox" value="1" {if $user_terms_of_use eq "1"}checked="checked" {/if} /> {$lang8}
                                </div>
                            </div>
                        </form>
                    </div>
