...
<body class="inner">
    ...
    {/literal} {/if} {if $smarty.session.USERID ne ""} {literal}
    <script type="text/javascript">
    ...
    <div class="header">
        <div class="centerwrap relative">
            <div class="headertop">
                <div class="logo">
                    <a href="{$baseurl}"><img src="{$imageurl}/scriptolution_logo.png" alt="{$site_name}" /></a>
                </div>
                ...
                {include file='scriptolution_dotcom_notifications.tpl'} {if $smarty.session.USERID ne ""}
                <div class="logoutheader">
                    <div class="usernamebox droparrow">
                        ...
                        <div class="userimage">
                            <a href="{$baseurl}{insert name=get_seo_profile value=a username=$smarty.session.USERNAME|stripslashes}"><img src="{$membersprofilepicurl}/thumbs/{$myprofilepicture}" alt="{$smarty.session.USERNAME}" height="25px" width="25px" /></a>
                        </div>
                        <p>{$lang29}</p>
                        <div class="clear"></div>
                        <div class="dropdownbox">
                            <ul>
                                {if $enable_ref eq "1"}
                                <li><a href="{$baseurl}myreferrals">{$lang512}</a></li>{/if}
                    ...
                    <div class="textdropdown sublinks">
                        ...
                        <div class="dropdownbox">
                            <ul>
                                ...
                                <li><a href="{$baseurl}balance">{$lang653}</a></li>
                                {include file='scriptolution_co_bit2.tpl'}
                            </ul>
                        </div>
                    </div>
                    <div class="massage">
                        <a href="#" onclick="scriptolutions_fiverrscript_toggleit('scriptolution-notifications-popup');"><img id="scriptolution-master" src="{$imageurl}/scriptolution_chat.png" style="margin-top: 5px;" /></a>
                    </div>
                    <div class="todo leftborder">
                        {insert name=msg_cnt value=var assign=msgc}
                        <p>
                            <a href="{$baseurl}inbox">{$lang28}</a>
                            <span>{$msgc}</span>
                        </p>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="headeright">
                    <ul>
                        ...
                        <li><a href="{$baseurl}login">{$lang2} old</a></li>
                        <li><a role="button" data-toggle="modal" data-target="#login-modal" class="join">{$lang1} new</a></li>
                    </ul>
                </div>
                {/if}
                <div class="clear"></div>
        ...
        <div class="subnav">
            <div class="centerwrap">
                <ul>
                    {insert name=get_categories assign=c} {section name=i loop=$c max=10}
                    <li><a href="{$baseurl}categories/{$c[i].seo|stripslashes}">{$c[i].name|stripslashes}</a> {insert name=get_subcategories assign=subcat value=var parent=$c[i].CATID} {if $subcat|@count GT "0"}
                        <div class="menubox">
                            <div class="menulist">
                                <ul>
