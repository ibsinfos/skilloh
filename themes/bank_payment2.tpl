                    ...
                    <div id="scriptolutionOrderingForm" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <ul class="profile">
                                        <li class="location clearfix">
                                            ...
                                            <div class="pull-right">
                                                {if $scriptolution_cur_pos eq "1"} {$fprice}{$lang197}
                                                <p class="lang-item">{$fprice}<sup>{$lang197}</sup></p>
                                                {else}
                                                <p class="lang-item"><sup>{$lang197}</sup> {$fprice}</p>
                                                {/if}
                                            </div>
                                        </li>
                                        <li class="language clearfix">
                                            ...
                                            <div class="pull-right">
                                                <p class="lang-item">#{$p.PID|stripslashes}</p>
                                            </div>
                                        </li>
                                        <li class="location clearfix">
                                            <div class="pull-left">
                        ...
                        <div id="scriptolutionOrderingForm" class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <div class="card_design col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h1 class="myshoppingheading">{$langl0} ({$lang455})</h1>
                                ...
                                <form action="{$baseurl}bank_payment2.php?item={$p.PID|stripslashes}" method="post">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 payment_bank_detail">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="texta form-controls" name="pname" value="{$p.fullname|stripslashes}" placeholder="Ram Kumar">
                                        </div>
                                    </div>
