							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" " align="center">{$results[i].PID}</td>
                                        ...
                                        <td class=" last">
                                            ...
                                            <input type="hidden" name="BIID" value="{$results[i].PID}" />
                                            <input type="hidden" name="BUSERID" value="{$results[i].USERID}" />
                                            <input type="hidden" name="asub" value="1" />
                                            </form>
                                        	<a href="javascript: document.a{$results[i].BID}.submit();">THEN CLICK HERE AND THE GIG WILL BE FEATURED</a>
                                            <br />OR<br />
                                            <a href="local_validate2.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&title={$title}&IID={$IID}&username={$username}&PAYPAL={$PAYPAL}{/if}&delete=1&DBID={$results[i].BID}">CLICK HERE TO DELETE</a>
                                        </td>
                                	</tr>
                                    {/section}
                                    <tr>
