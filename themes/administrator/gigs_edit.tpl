				...
				<div class="columns ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="2" {if $gig.active eq 2}selected{/if}>Suspended By User</option>
                                                            <option value="4" {if $gig.active eq 4}selected{/if}>Suspended By Admin</option>
                                                            <option value="3" {if $gig.active eq 3}selected{/if}>Deleted</option>
                                                            </select>
                                                        </td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <form action="gigs_edit.php?PID={$PID}" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
