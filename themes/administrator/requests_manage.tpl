							...
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        ...
                                        <th ><span class="nobr"><a href="requests_manage.php?page={$currentpage}&sortby=status&sorthow={if $sortby eq "status"}{if $sorthow eq "desc"}asc{else}desc{/if}{else}{$sorthow}{/if}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&scriptolutiondesc={$scriptolutiondesc}&username={$username}&status={$status}{/if}" name="status" class="{if $sortby eq "status"}sort-arrow-{if $sorthow eq "desc"}desc{else}asc{/if}{else}not-sort{/if}"><span class="sort-title">Active</span></a></span></th>
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" ">
                                        	<form name="a{$results[i].REQUESTID}" id="a{$results[i].REQUESTID}" action="" method="post">
                                        	...
                                        	<a href="javascript: document.a{$results[i].REQUESTID}.submit();">{if $results[i].active eq "1"}Yes{else}No{/if}</a>
                                        </td>
                                        <td class=" last"><a href="requests_edit.php?REQUESTID={$results[i].REQUESTID}">Edit</a>&nbsp;|&nbsp;<a href="requests_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&scriptolutiondesc={$scriptolutiondesc}&username={$username}&status={$status}{/if}&delete=1&REQUESTID={$results[i].REQUESTID}">Delete</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="5">
