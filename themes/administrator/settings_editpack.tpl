                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="pminprice" name="pminprice" value="{$p.pminprice}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="pmaxprice" name="pmaxprice" value="{$p.pmaxprice}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
