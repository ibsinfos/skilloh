                                ...
                                <div class="form-entry1">
                                    ...
                                    <div class="sparttwo">
                                        ...
                                        <div class="spartfour">
                                            ...
                                            {if $scriptolution_cur_pos eq "1"}<select name="gprice" id="gprice" class="textb">{section name=p loop=$packs}<option value="{$packs[p].ID|stripslashes}" {if $gprice eq $packs[p].ID|stripslashes}selected="selected"{/if}>{$packs[p].pprice|stripslashes}</option>{/section}</select>{$lang197}{else}{$lang197}<select name="gprice" id="gprice" class="textb">{section name=p loop=$packs}<option value="{$packs[p].ID|stripslashes}" {if $gprice eq $packs[p].ID|stripslashes}selected="selected"{/if}>{$packs[p].pprice|stripslashes}</option>{/section}</select>{/if}
                                            {/if}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-entry">
                                  ...
                                  <div class="form-entry">
                                    ...
                                    <div class="column-r">
                                      ...
                                      {$lang618}: <input name="scriptolutioncity" class="textread scriptolutionauto" id="locality" disabled="true" readonly="readonly" value="{$scriptolutioncity|stripslashes}"></input>
                                      {$lang619}: <input name="scriptolutionstate" class="textread scriptolutionauto" id="administrative_area_level_1" disabled="true" readonly="readonly" value="{$scriptolutionstate|stripslashes}"></input>
                                      {$lang467}: <input name="scriptolutioncountry" class="textread scriptolutionauto" id="country" disabled="true" readonly="readonly" value="{$scriptolutioncountry|stripslashes}"></input>
                                    </div>
                                  </div>
                              	  <div class="scriptolutionclear"></div>
                                  {/if}
