                                ...
                                <div class="form-entry1">
                                    ...
                                    <div class="sparttwo">
                                        ...
                                        <div class="spartfour">
                                            ...
                                            {if $scriptolution_cur_pos eq "1"}{$lang589} {$g.price}{$lang197}{else}{$lang63}{$g.price}{/if}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-entry">
                                  ...
                                  <div class="form-entry">
                                    ...
                                    <div class="column-r">
                                      ...
                                      {$lang618}: <input name="scriptolutioncity" class="textread scriptolutionauto" id="locality" disabled="true" readonly="readonly" value="{$g.scriptolutioncity|stripslashes}"></input>
                                      {$lang619}: <input name="scriptolutionstate" class="textread scriptolutionauto" id="administrative_area_level_1" disabled="true" readonly="readonly" value="{$g.scriptolutionstate|stripslashes}"></input>
                                      {$lang467}: <input name="scriptolutioncountry" class="textread scriptolutionauto" id="country" disabled="true" readonly="readonly" value="{$g.scriptolutioncountry|stripslashes}"></input>
                                    </div>
                                  </div>
                              	  <div class="scriptolutionclear"></div>
                                  {/if}
