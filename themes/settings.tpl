    ...
    <div class="container scriptolutionpaddingtop30">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin30 scriptolutioneditpages">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 aside-detail-bar mobpad_00">
                    <div class="box-aside">
                        <div class="personal-profile">
                            <h4 class="float-center">{$lang31}</h4>
                            <div class="line">
                                <span class="line-distance"></span>
                            </div>
                            <ul class="profile">
                                <li role="presentation" class="active location clearfix hvr-wobble-horizontal">
                                    <div class="pull-left">
                                        <span><i class="fa fa-chevron-right"></i> <a href="#home" aria-controls="home" role="tab" data-toggle="tab">Edit Profile</a> </span>
                                    </div>
                                </li>
                                <li role="presentation" class="location clearfix hvr-wobble-horizontal">
                                    <div class="pull-left">
                                        <span><i class="fa fa-chevron-right"></i> <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Payment Details</a> </span>
                                    </div>
                                </li>
                                <li role="presentation" class="location clearfix hvr-wobble-horizontal">
                                    <div class="pull-left">
                                        <span><i class="fa fa-chevron-right"></i> <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Change Password</a> </span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 mobpad_00">
                            ...
                            <div id="scriptolutionPostForm">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 card_design">
                                    <form action="{$baseurl}settings" enctype="multipart/form-data" method="post">
                                        ...
                                        <h1 class="setting_title">Edit Profile</h1>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pay_space">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 z_padding0 pay_space">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 z_padding0 pay_space pay_space_m">
                                            <div class="form-entry col-lg-6 col-md-6 col-sm-6 col-xs-12 pay_space_mobile">
                                                <div class="column-l">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 z_padding0 pay_space pay_space_m ">
                                            <div class="form-entry col-lg-6 col-md-6 col-sm-6 col-xs-12 pay_space_mobile">
                                                ...
                                                <div class="column-r">
                                                    <input class="text" id="email" name="email" size="30" type="text" value="{$p.email|stripslashes}" /> {if $smarty.session.VERIFIED eq "0"}
                                                    <div style="clear:both"></div>
                                                    <label>&nbsp;</label><a style="color: #45b5dc;" href="{$baseurl}resendconfirmation.php">{$lang480}</a>{/if}
                                                </div>
                                            </div>
		                               ...
		                               {/if}-->
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pay_space">
											<div class="form-entry pull-right">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="profile">                            
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 card_design">
                                <form action="{$baseurl}settings" class="reset-form" id="edit_pass_{$smarty.session.USERID}" method="post">
                                    ...
                                    <h1 class="setting_title">{$langl17}</h1>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pay_space">
										<div class="form-entry">
											<div class="column-l">
