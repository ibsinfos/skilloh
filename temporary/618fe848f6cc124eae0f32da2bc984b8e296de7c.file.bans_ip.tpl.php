<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 04:00:19
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/bans_ip.tpl" */ ?>
<?php /*%%SmartyHeaderCode:831166740578898138f8cd3-30305525%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '618fe848f6cc124eae0f32da2bc984b8e296de7c' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/bans_ip.tpl',
      1 => 1468533500,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '831166740578898138f8cd3-30305525',
  'function' => 
  array (
  ),
 ...
 IPs
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="bans_ip.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=ip&sorthow=<?php if ($_smarty_tpl->getVariable('sortby')->value=="ip"){?><?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>asc<?php }else{ ?>desc<?php }?><?php }else{ ?><?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('search')->value=="1"){?>&ip=<?php echo $_smarty_tpl->getVariable('ip')->value;?>
<?php }?>" name="ips" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="ip"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">IP</span></a></span></th>
                                        <th  class=" no-link last"><span class="nobr">Action</span></th>
	                	            </tr>
	            	            	<tr class="filter">
                                        <th ><input type="text" name="ip" id="ip" value="<?php echo stripslashes($_smarty_tpl->getVariable('ip')->value);?>
...
?>
                                    <tr id="" >
                                        <td class=" a-right "><?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ip'];?>
</td>
                                        <td class=" last"><a href="bans_ip.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=<?php echo $_smarty_tpl->getVariable('sortby')->value;?>
&sorthow=<?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
<?php if ($_smarty_tpl->getVariable('search')->value=="1"){?>&ip=<?php echo $_smarty_tpl->getVariable('ip')->value;?>
<?php }?>&delete=1&DIP=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ip'];?>
">Delete</a></td>
                                	</tr>
                                    <?php endfor; endif; ?>
                                    <tr>
