<?php /* Smarty version Smarty-3.0.7, created on 2016-08-22 17:04:06
         compiled from "C:/wamp/www/GIT/skilloh/themes\administrator/gigs_deleted.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1873857bb68c6cbe883-39996909%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '453d30968b2ca8cc299e4f5f9cb7ab3ddbd3e7ba' => 
    array (
      0 => 'C:/wamp/www/GIT/skilloh/themes\\administrator/gigs_deleted.tpl',
      1 => 1471688043,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1873857bb68c6cbe883-39996909',
  'function' => 
  array (
  ),
...
?>		<div class="middle" id="anchor-content">
				...
				<div class="columns ">
					...
					<div class="side-col" id="page:left">
                        ...
                        <ul id="isoft" class="tabs">
                            ...
                            <li >
        						<a href="gigs_manage.php" id="isoft_group_3" name="group_3" title="Manage Gigs" class="tab-item-link ">
                                    <span>
    						...
    						<li >
        						<a href="gigs_deleted.php" id="isoft_group_1" name="group_1" title="Deleted Gigs" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Deleted Gigs
                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Deleted Gigs</h4>
 ...
 Gigs
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='gigs_deleted.php'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="gigs_deleted.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
">Edit</a>&nbsp;|&nbsp;
                                            <a href="gigs_deleted.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
">Delete Forever</a></td>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Gigs - Deleted Gigs</h3>
                            </div>
                            
                            <form action="gigs_deleted.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
