<?php /* Smarty version Smarty-3.0.7, created on 2016-08-22 17:03:56
         compiled from "C:/wamp/www/GIT/skilloh/themes\administrator/gigs_validate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2272257bb68bcd8c946-35517997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4410d5f7ef72f4107cc4e621c56cb94bcad013d6' => 
    array (
      0 => 'C:/wamp/www/GIT/skilloh/themes\\administrator/gigs_validate.tpl',
      1 => 1471688043,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2272257bb68bcd8c946-35517997',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_date_format')) include 'C:\wamp\www\GIT\skilloh\smarty\libs\plugins\modifier.date_format.php';
?>		<div class="middle" id="anchor-content">
                                ...
                                <div id="isoft_group_2_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Validate Gigs</h4>
 ...
 Gigs
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='gigs_validate.php'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="gigs_validate.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="gtitle" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="gtitle"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Description</span></a></span></th>
                                        <th ><span class="nobr"><a href="gigs_validate.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=pip&sorthow=<?php if ($_smarty_tpl->getVariable('sortby')->value=="pip"){?><?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>asc<?php }else{ ?>desc<?php }?><?php }else{ ?><?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
<?php }?><?php if ($_smarty_tpl->getVariable('search')->value=="1"){?>&fromid=<?php echo $_smarty_tpl->getVariable('fromid')->value;?>
&toid=<?php echo $_smarty_tpl->getVariable('toid')->value;?>
&title=<?php echo $_smarty_tpl->getVariable('title')->value;?>
&gtitle=<?php echo $_smarty_tpl->getVariable('gtitle')->value;?>
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="pip" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="pip"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">IP</span></a></span></th>
                                        <th ><span class="nobr"><a href="gigs_validate.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="username" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="username"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Owner</span></a></span></th>
                                        <th ><span class="nobr"><a href="gigs_validate.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="time_added" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="time_added"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Date Added</span></a></span></th>
...
<?php $_template = new Smarty_Internal_Template("administrator/gigs_instant_bit.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('subresults',$_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]); echo $_template->getRenderedTemplate();?><?php unset($_template);?><?php $_template = new Smarty_Internal_Template("administrator/gigs_extras_bit.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('subresults',$_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]); echo $_template->getRenderedTemplate();?><?php unset($_template);?></td>
                                        <td class=" "><?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['pip'];?>
</td>
...
.submit();">Approve</a>&nbsp;|&nbsp;
                                            <a href="gigs_edit.php?PID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
">Edit</a>&nbsp;|&nbsp;
                                            <a href="gigs_validate.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
">Delete</a></td>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Gigs - Validate Gigs</h3>
                            </div>
                            
                            <form action="gigs_validate.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
