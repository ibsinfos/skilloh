<?php /* Smarty version Smarty-3.0.7, created on 2016-07-31 23:51:53
         compiled from "/home/skilohx6/public_html/dev/themes/scriptolution_bit_last3_my.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2112021422579ec759b63d45-57673350%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79f63a764a76cd4ec242d29ca246a14fad7f8f05' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/scriptolution_bit_last3_my.tpl',
      1 => 1468533452,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2112021422579ec759b63d45-57673350',
  'function' => 
  array (
  ),
...
sQuery(document).ready(function() {
	sQuery('#scriptolution_unheart_<?php echo $_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
').click(function() {
		sQuery.post('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/bookmark?id=<?php echo stripslashes($_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID']);?>
&do=rem', sQuery(this).serialize(),function(data){
			sQuery('#scriptolutiongig<?php echo $_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
').hide();
		});
		return false;
	});
                        ...
                        <div class="cusongsblock <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['i']['iteration']%3==0){?>last<?php }?>" id="scriptolutiongig<?php echo $_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
">
...
" width="214" height="132" /></a>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?><?php }?>
                            ...
                            <div class="price"><?php if ($_smarty_tpl->getVariable('scriptolution_cur_pos')->value=="1"){?><?php echo stripslashes($_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['price']);?>
...
<?php }?></a>
                            ...
                            <div style="padding-bottom:10px;">
                                <a href="javascript:void();" class="ascriptolutiongreenbutton" id="scriptolution_unheart_<?php echo $_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
...
"><?php echo smarty_modifier_truncate(stripslashes($_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['username']),20,"...",true);?>
                                ...
                                <div class="otherdetails">
                                    ...
                                    <span class="flag"><span class="country <?php echo $_smarty_tpl->getVariable('posts')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['country'];?>
