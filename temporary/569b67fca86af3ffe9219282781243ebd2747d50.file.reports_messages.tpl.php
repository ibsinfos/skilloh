<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 03:59:36
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/reports_messages.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1728343332578897e8cd29e0-92829297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '569b67fca86af3ffe9219282781243ebd2747d50' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/reports_messages.tpl',
      1 => 1468533523,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1728343332578897e8cd29e0-92829297',
  'function' => 
  array (
  ),
 ...
 Reported Messages
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="reports_messages.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&msg=<?php echo $_smarty_tpl->getVariable('msg')->value;?>
<?php }?>" name="username" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="username"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Sender</span></a></span></th>
                                        <th ><span class="nobr"><a href="reports_messages.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
?>
                                    <tr id="" >
                                        ...
                                        <td class=" last"><a href="reports_messages.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&msg=<?php echo $_smarty_tpl->getVariable('msg')->value;?>
<?php }?>&delete=2&DMID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['MID'];?>
&DRID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['RID'];?>
">Delete Message</a>&nbsp;|&nbsp;<a href="reports_messages.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=<?php echo $_smarty_tpl->getVariable('sortby')->value;?>
&sorthow=<?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
<?php if ($_smarty_tpl->getVariable('search')->value=="1"){?>&fromid=<?php echo $_smarty_tpl->getVariable('fromid')->value;?>
&toid=<?php echo $_smarty_tpl->getVariable('toid')->value;?>
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
&msg=<?php echo $_smarty_tpl->getVariable('msg')->value;?>
<?php }?>&delete=1&DRID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['RID'];?>
">Delete Report</a></td>
                                	</tr>
                                    <?php endfor; endif; ?>
                                    <tr>
