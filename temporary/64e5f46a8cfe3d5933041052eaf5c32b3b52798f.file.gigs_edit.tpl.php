<?php /* Smarty version Smarty-3.0.7, created on 2016-08-25 23:22:58
         compiled from "C:/wamp/www/GIT/skilloh/themes\administrator/gigs_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2215457bfb612ef24c5-04813745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64e5f46a8cfe3d5933041052eaf5c32b3b52798f' => 
    array (
      0 => 'C:/wamp/www/GIT/skilloh/themes\\administrator/gigs_edit.tpl',
      1 => 1471688043,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2215457bfb612ef24c5-04813745',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('gig')->value['category']==$_smarty_tpl->getVariable('listallcats')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['CATID']){?>selected<?php }?>><?php echo stripslashes($_smarty_tpl->getVariable('listallcats')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name']);?>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="2" <?php if ($_smarty_tpl->getVariable('gig')->value['active']==2){?>selected<?php }?>>Suspended By User</option>
                                                            <option value="4" <?php if ($_smarty_tpl->getVariable('gig')->value['active']==4){?>selected<?php }?>>Suspended By Admin</option>
                                                            <option value="3" <?php if ($_smarty_tpl->getVariable('gig')->value['active']==3){?>selected<?php }?>>Deleted</option>
                                                            </select>
                                                        </td>
...
" />
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <form action="gigs_edit.php?PID=<?php echo $_smarty_tpl->getVariable('PID')->value;?>
