<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 04:00:56
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/bans_words_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41469382057889838f30485-07133944%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa76127ccd9102427c9a90deb53dd2d382c54db7' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/bans_words_add.tpl',
      1 => 1468533501,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '41469382057889838f30485-07133944',
  'function' => 
  array (
  ),
                                ...
                                <div id="isoft_group_4_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Add Word</h4>
										...
										<fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">Word </label></td>
                                                        <td class="value">
                                                        	<input id="add" name="add" value="" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[WORD YOU WANT TO BAN]</td>
                                                            <td><small></small></td>
                                                    </tr>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Bans - Add Word</h3>
                            ...
                            <form action="bans_words_add.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
