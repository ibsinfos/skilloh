<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 04:09:40
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/settings_static.tpl" */ ?>
<?php /*%%SmartyHeaderCode:128176274457889a448f3165-91907380%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '360ba2004811447ab914fd16fd2335c74845e6d3' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/settings_static.tpl',
      1 => 1468533534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128176274457889a448f3165-91907380',
  'function' => 
  array (
  ),
...
" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Job Levels Title </label></td>
                                                        <td class="value">
                                                            <input name="title6" value="<?php echo htmlspecialchars(stripslashes($_smarty_tpl->getVariable('static6')->value['title']));?>
" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Job Levels Data </label></td>
                                                        <td class="value">
                                                            <textarea name="value6" class=" textarea ckeditor" type="textarea" ><?php echo htmlspecialchars(stripslashes($_smarty_tpl->getVariable('static6')->value['value']));?>
</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
