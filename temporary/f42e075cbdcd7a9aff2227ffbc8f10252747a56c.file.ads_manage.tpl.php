<?php /* Smarty version Smarty-3.0.7, created on 2016-08-10 10:06:57
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/ads_manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:177518748457ab350196cd01-59372943%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f42e075cbdcd7a9aff2227ffbc8f10252747a56c' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/ads_manage.tpl',
      1 => 1468533498,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '177518748457ab350196cd01-59372943',
  'function' => 
  array (
  ),
 ...
 Advertisements
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="ads_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=AID&sorthow=<?php if ($_smarty_tpl->getVariable('sortby')->value=="AID"){?><?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>asc<?php }else{ ?>desc<?php }?><?php }else{ ?><?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
...
<?php }?>" name="id" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="AID"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">ID</span></a></span></th>
                                        <th ><span class="nobr"><a href="ads_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&details=<?php echo $_smarty_tpl->getVariable('details')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="details" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="details"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Description</span></a></span></th>
                                        <th ><span class="nobr"><a href="ads_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
?>
                                    <tr id="" >
                                        <td align="center"><?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
</td>
                                        <td class=" "><?php echo stripslashes($_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['description']);?>
</td>
                                        <td class=" ">
                                        	<form name="a<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
" id="a<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
" action="" method="post">
                                            <input type="hidden" name="AAID" value="<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
" />
...
" />
                                        	...
                                        	<a href="javascript: document.a<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
.submit();"><?php if ($_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['active']=="1"){?>Yes<?php }else{ ?>No<?php }?></a>
                                        ...
                                        <td class=" last">
                                        	<a href="ads_preview.php?AID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
">Preview</a>&nbsp;|&nbsp;
                                            <a href="ads_code.php?AID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
">Get Code</a>&nbsp;|&nbsp;
                                        	<a href="ads_edit.php?AID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
">Edit</a>&nbsp;|&nbsp;
                                            <a href="ads_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&details=<?php echo $_smarty_tpl->getVariable('details')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>&delete=1&AID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['AID'];?>
">Delete</a>
                                        </td>
                                	</tr>
                                    <?php endfor; endif; ?>
