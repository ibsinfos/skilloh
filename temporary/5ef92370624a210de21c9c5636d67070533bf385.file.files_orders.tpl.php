<?php /* Smarty version Smarty-3.0.7, created on 2016-08-02 23:55:27
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/files_orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186507186957a16b2f3978d8-54375991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ef92370624a210de21c9c5636d67070533bf385' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/files_orders.tpl',
      1 => 1468533508,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186507186957a16b2f3978d8-54375991',
  'function' => 
  array (
  ),
				...
				<div class="columns ">
					...
					<div class="side-col" id="page:left">
                        ...
                        <ul id="isoft" class="tabs">
    						...
    						<li >
        						<a href="files_orders.php" id="isoft_group_1" name="group_1" title="Order Files" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Order Files
 ...
 Files
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='files_orders.php'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="files_orders.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&details=<?php echo $_smarty_tpl->getVariable('details')->value;?>
&active=<?php echo $_smarty_tpl->getVariable('active')->value;?>
<?php }?>" name="active" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="active"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">Username</span></a></span></th>
...
" target="_blank"><?php echo $_smarty_tpl->getVariable('fd')->value[$_smarty_tpl->getVariable('smarty')->value['section']['x']['index']]['fname'];?>
 <b>[<?php echo $_smarty_tpl->getVariable('afs')->value;?>
                                        ...
                                        <td class=" ">
                                        	<?php echo stripslashes($_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['username']);?>

                                        </td>
                                        <td class=" last">
                                            <a href="files_orders.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
">Delete</a>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Files - Order Files</h3>
                            </div>
                            
                            <form action="files_orders.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
