<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 03:56:44
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/admins_manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20749427105788973c55da33-03499052%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73265f655da4b8b0daed8bbd6a6fa40622bb4dd5' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/admins_manage.tpl',
      1 => 1468533496,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20749427105788973c55da33-03499052',
  'function' => 
  array (
  ),
 ...
 Administrators
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="admins_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
&sortby=ADMINID&sorthow=<?php if ($_smarty_tpl->getVariable('sortby')->value=="ADMINID"){?><?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>asc<?php }else{ ?>desc<?php }?><?php }else{ ?><?php echo $_smarty_tpl->getVariable('sorthow')->value;?>
...
<?php }?>" name="id" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="ADMINID"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">ID</span></a></span></th>
                                        <th ><span class="nobr"><a href="admins_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&email=<?php echo $_smarty_tpl->getVariable('email')->value;?>
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
<?php }?>" name="email" class="<?php if ($_smarty_tpl->getVariable('sortby')->value=="email"){?>sort-arrow-<?php if ($_smarty_tpl->getVariable('sorthow')->value=="desc"){?>desc<?php }else{ ?>asc<?php }?><?php }else{ ?>not-sort<?php }?>"><span class="sort-title">E-Mail Address</span></a></span></th>
                                        <th ><span class="nobr"><a href="admins_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
?>
                                    <tr id="" >
                                        <td align="center"><?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ADMINID'];?>
</td>
                                        <td class=" "><?php echo stripslashes($_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['email']);?>
</td>
                                        ...
                                        <td class=" last">
                                        	<a href="admins_edit.php?ADMINID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ADMINID'];?>
">Edit</a>&nbsp;|&nbsp;
                                            <a href="admins_manage.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
&email=<?php echo $_smarty_tpl->getVariable('email')->value;?>
&username=<?php echo $_smarty_tpl->getVariable('username')->value;?>
<?php }?>&delete=1&ADMINID=<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ADMINID'];?>
">Delete</a>
                                        </td>
                                	</tr>
                                    <?php endfor; endif; ?>
