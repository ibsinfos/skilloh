<?php /* Smarty version Smarty-3.0.7, created on 2016-07-15 03:57:42
         compiled from "/home/skilohx6/public_html/dev/themes/administrator/local_validate2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179361922557889776435976-38712822%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ed438e443832bb187b589f3e75c1b2ab0ad84bd' => 
    array (
      0 => '/home/skilohx6/public_html/dev/themes/administrator/local_validate2.tpl',
      1 => 1468533704,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179361922557889776435976-38712822',
  'function' => 
  array (
  ),
...
?>		<div class="middle" id="anchor-content">
				...
				<div class="columns ">
					...
					<div class="side-col" id="page:left">
                        ...
                        <ul id="isoft" class="tabs">
    						...
    						<li >
        						<a href="local_validate2.php" id="isoft_group_1" name="group_1" title="Validate Local Feature Payments" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Validate Local Feature Payments</h4>
 ...
 Payments
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='local_validate2.php'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="local_validate2.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
?>
                                    <tr id="" >
                                        ...
                                        <td class=" " align="center"><?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
</td>
...
" />
                                            <input type="hidden" name="BIID" value="<?php echo $_smarty_tpl->getVariable('results')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
" />
...
.submit();">THEN CLICK HERE AND THE GIG WILL BE FEATURED</a>
                                            <br />OR<br />
                                            <a href="local_validate2.php?page=<?php echo $_smarty_tpl->getVariable('currentpage')->value;?>
...
">CLICK HERE TO DELETE</a>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Local Bank - Validate Local Feature Payments</h3>
                            </div>
                            
                            <form action="local_validate2.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
