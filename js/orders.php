...
$(document).ready( function() {
    ...
    $('.message_toggler').click(function() {
        ...
        $('#scriptolutiondelivery').removeClass('select-deliver');
        $('#problems_box').hide();
        $('.msg-error').hide()
    ...
    $('.deliver_toggler').click(function() {
        ...
        $('#scriptolutiondelivery').addClass('select-deliver');
        $('.boxes .box').removeClass('selected');
        $('.radio_button').attr('checked', false);
        $('#problems_box').hide();
        $('.msg-error').hide();
...
function scriptolutionreinitialise()
{
    $.post( "<?php echo $config['baseurl']; ?>/scriptolutionreupload.php", function( data ) {
      $( "#scriptolutionuploader" ).html( data );
    });
}