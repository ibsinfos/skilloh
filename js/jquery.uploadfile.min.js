 ...
 */
! function(e) {
    void 0 == e.fn.ajaxForm && e.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "taken.to/cdn/jquery.form.php");
    var a = {};
            ...
            for (var o = 0; o < r.length; o++)
                if (n(t, a, r[o].name))
                    if (a.allowDuplicates || !d(t, r[o].name))
                        ...
                        else if (-1 != a.maxFileCount && t.selectedFiles >= a.maxFileCount) a.showError && e("<div class='" + a.errorClass + "'>" + a.maxFileCountErrorStr + "</div>").appendTo(t.errorLog);
            else {
